...
import com.example.trabalhopds1.domain.PagamentoComCartao;
...
import com.example.trabalhopds1.domain.enums.Perfil;
...
import com.example.trabalhopds1.repositories.EstadoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "mayllats@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		Cliente cli2 = new Cliente(null, "Ana Costa Silva", "mayllatabata@gmail.com", "75823142048", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		cli1.getTelefones().addAll(Arrays.asList("33363323", "93899393"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "apto 303", "Jardim", "38220834", cli1,c1);
		Endereco e2 = new Endereco(null, "Av Matos", "105", "sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Av Floriano", "21056", null, "Centro", "38700012", cli2, c2);
